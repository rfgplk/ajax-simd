...
load(B *ptr)
{
  if constexpr ( stdlib::is_same_v<B, i128> ) {
  ...
  if constexpr ( stdlib::is_same_v<B, i256> ) {
...
template <is_simd_type B, i32 scale>
inline B
...
template <int scale>
inline i128
gather_64_i32(i64 *base, i128 vindex)
{
...
template <int scale>
inline i128
gather_64_i32(i64 &ref, i128 vindex)
{
...
template <int scale>
inline i256
gather_64_i32(i64 &ref, i256 vindex)
{
  return gather_64_i32<scale>(&ref, vindex);
}
...
template <int scale>
inline d256
gather_pd_i32(double &ref, i256 vindex)
{
  return gather_pd_i32<scale>(&ref, vindex);
}
...
template <is_simd_type B, i32 scale>
inline B
gather_64_i64(i64 *base, B vindex)
{
  if constexpr ( stdlib::is_same_v<B, i128> ) {
...
template <is_simd_type B, i32 scale>
inline B
gather_64_i64(i64 &ref, B vindex)
{
...
template <is_simd_type B, i32 scale>
inline B
maskgather_32_i32(B src, i32 *base, B vindex, B mask)
{
  if constexpr ( stdlib::is_same_v<B, i128> ) {
...
template <is_simd_type B, i32 scale>
inline B
maskgather_32_i32(B src, i32 &ref, B vindex, B mask)
{
...
template <int scale>
inline i128
maskgather_64_i32(i128 src, i64 *base, i128 vindex, i128 mask)
{
...
template <int scale>
inline i128
maskgather_64_i32(i128 src, i64 &ref, i128 vindex, i128 mask)
{
...
template <int scale>
inline i256
maskgather_64_i32(i256 src, i64 *base, i128 vindex, i256 mask)
{
...
template <int scale>
inline i256
maskgather_64_i32(i256 src, i64 &ref, i128 vindex, i256 mask)
{
  return maskgather_64_i32<scale>(src, &ref, vindex, mask);
}
...
template <is_simd_type B, i32 scale>
inline i128
maskgather_32_i64(i128 src, i32 *base, B vindex, i128 mask)
{
  if constexpr ( stdlib::is_same_v<B, i128> ) {
...
template <is_simd_type B, i32 scale>
inline i128
maskgather_32_i64(i128 src, i32 &ref, B vindex, i128 mask)
{
...
template <is_simd_type B, i32 scale>
inline B
maskgather_64_i64(B src, i64 *base, B vindex, B mask)
{
  if constexpr ( stdlib::is_same_v<B, i128> ) {
...
template <is_simd_type B, i32 scale>
inline B
maskgather_64_i64(B src, i64 &ref, B vindex, B mask)
{
