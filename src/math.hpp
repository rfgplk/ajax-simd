...
abs_8(T &o)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
    return _mm_abs_epi8(o);
  }
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i256> ) {
...
abs_32(T &o)
{
  ...
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i512> ) {
...
abs(T &o)
{
  if constexpr ( stdlib::is_same_v<typename T::lane_width, __v8> ) {
    return abs_8(o);
  }
  if constexpr ( stdlib::is_same_v<typename T::lane_width, __v16> ) {
    return abs_16(o);
  }
  if constexpr ( stdlib::is_same_v<typename T::lane_width, __v32> ) {
    return abs_32(o);
  }
  if constexpr ( stdlib::is_same_v<typename T::lane_width, __v64> ) {
    return abs_64(o);
  }
}
...
sqrt(B &o)
{
  if constexpr ( stdlib::is_same_v<B, f128> ) {
    return _mm_sqrt_ps(o);
  }
  if constexpr ( stdlib::is_same_v<B, f256> ) {
    return _mm256_sqrt_ps(o);
  }
  if constexpr ( stdlib::is_same_v<B, f512> ) {
    return _mm512_sqrt_ps(o);
  }     // AVX-512F
  if constexpr ( stdlib::is_same_v<B, d128> ) {
    return _mm_sqrt_pd(o);
  }
  if constexpr ( stdlib::is_same_v<B, d256> ) {
    return _mm256_sqrt_pd(o);
  }
  if constexpr ( stdlib::is_same_v<B, d512> ) {
    return _mm512_sqrt_pd(o);
  }     // AVX-512F
  if constexpr ( stdlib::is_same_v<B, h128> ) {
    return _mm_sqrt_ph(o);
  }     // AVX-512FP16
  if constexpr ( stdlib::is_same_v<B, h256> ) {
    return _mm256_sqrt_ph(o);
  }
  if constexpr ( stdlib::is_same_v<B, h512> ) {
...
inline f128
sqrt_round_ss(f128 src, f128 a, f128 b, i32 r)
{
...
inline d128
sqrt_round_sd(d128 src, d128 a, d128 b, i32 r)
{
...
template <is_simd_type B, typename M>
inline B
mask_sqrt_round(B src, M k, B &o, i32 rounding)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <is_simd_type B, typename M>
inline B
maskz_sqrt_round(M k, B &o, i32 rounding)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <typename M>
inline f128
mask_sqrt_round_ss(f128 src, M k, f128 a, f128 b, i32 r)
{
...
template <typename M>
inline f128
maskz_sqrt_round_ss(M k, f128 a, f128 b, i32 r)
{
...
template <typename M>
inline d128
mask_sqrt_round_sd(d128 src, M k, d128 a, d128 b, i32 r)
{
...
template <typename M>
inline d128
maskz_sqrt_round_sd(M k, d128 a, d128 b, i32 r)
{
...
inline f128
min_round_ss(f128 a, f128 b, i32 sae)
{
  return _mm_min_round_ss(a, b, sae);
}

inline d128
min_round_sd(d128 a, d128 b, i32 sae)
{
  return _mm_min_round_sd(a, b, sae);
}

inline h128
min_round_sh(h128 a, h128 b, i32 sae)
{
  return _mm_min_round_sh(a, b, sae);
}

inline f128
max_round_ss(f128 a, f128 b, i32 sae)
{
  return _mm_max_round_ss(a, b, sae);
}

inline d128
max_round_sd(d128 a, d128 b, i32 sae)
{
  return _mm_max_round_sd(a, b, sae);
}

inline h128
max_round_sh(h128 a, h128 b, i32 sae)
{
...
template <is_simd_type B, typename M>
inline B
mask_min_round(B src, M k, B &o, B &b, i32 sae)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <is_simd_type B, typename M>
inline B
maskz_min_round(M k, B &o, B &b, i32 sae)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <is_simd_type B, typename M>
inline B
mask_max_round(B src, M k, B &o, B &b, i32 sae)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <is_simd_type B, typename M>
inline B
maskz_max_round(M k, B &o, B &b, i32 sae)
{
  if constexpr ( stdlib::is_same_v<B, f512> ) {
...
template <typename M>
inline f128
mask_min_round_ss(f128 src, M k, f128 a, f128 b, i32 sae)
{
...
template <typename M>
inline f128
maskz_min_round_ss(M k, f128 a, f128 b, i32 sae)
{
...
template <typename M>
inline d128
mask_min_round_sd(d128 src, M k, d128 a, d128 b, i32 sae)
{
...
template <typename M>
inline d128
maskz_min_round_sd(M k, d128 a, d128 b, i32 sae)
{
...
template <typename M>
inline h128
mask_min_round_sh(h128 src, M k, h128 a, h128 b, i32 sae)
{
...
template <typename M>
inline h128
maskz_min_round_sh(M k, h128 a, h128 b, i32 sae)
{
...
template <typename M>
inline f128
mask_max_round_ss(f128 src, M k, f128 a, f128 b, i32 sae)
{
...
template <typename M>
inline f128
maskz_max_round_ss(M k, f128 a, f128 b, i32 sae)
{
...
template <typename M>
inline d128
mask_max_round_sd(d128 src, M k, d128 a, d128 b, i32 sae)
{
...
template <typename M>
inline d128
maskz_max_round_sd(M k, d128 a, d128 b, i32 sae)
{
...
template <typename M>
inline h128
mask_max_round_sh(h128 src, M k, h128 a, h128 b, i32 sae)
{
...
template <typename M>
inline h128
maskz_max_round_sh(M k, h128 a, h128 b, i32 sae)
{
...
inline f128
round_ss(f128 a, f128 b, i32 r)
{
  return _mm_round_ss(a, b, r);
}

inline d128
round_sd(d128 a, d128 b, i32 r)
{
