...
inline T
mask_slli_16(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_slli_16(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_slli_32(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_slli_32(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_slli_64(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_slli_64(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srli_16(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srli_16(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srli_32(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srli_32(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srli_64(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srli_64(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srai_16(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srai_16(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srai_32(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srai_32(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_srai_64(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_srai_64(M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_rol_32(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_rol_64(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_ror_32(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_ror_64(T &src, M k, T &o, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_shldi_64(T &src, M k, T &a, T &b, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_shldi_64(M k, T &a, T &b, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
mask_shrdi_64(T &src, M k, T &a, T &b, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
...
template <is_simd_class T, typename M>
inline T
maskz_shrdi_64(M k, T &a, T &b, i32 imm8)
{
  if constexpr ( stdlib::is_same_v<typename T::bit_width, i128> ) {
