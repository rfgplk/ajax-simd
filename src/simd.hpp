...
concept is_simd_class
    = stdlib::same_as<T, v8> or stdlib::same_as<T, v16> or stdlib::same_as<T, v32> or stdlib::same_as<T, v64>
      or stdlib::same_as<T, vfloat> or stdlib::same_as<T, vdouble> or stdlib::same_as<T, w8> or stdlib::same_as<T, w16>
      or stdlib::same_as<T, w32> or stdlib::same_as<T, w64> or stdlib::same_as<T, wfloat> or stdlib::same_as<T, wdouble>;
...
using v32 = ajax::v32;
using v64 = ajax::v64;
using vfloat = ajax::vfloat;
using vdouble = ajax::vdouble;

// Eigen like naming convention
using packet16c = ajax::packet16c;
using packet8s = ajax::packet8s;
using packet4i = ajax::packet4i;
using packet2l = ajax::packet2l;
using packet4f = ajax::packet4f;
using packet2d = ajax::packet2d;

using w8 = ajax::w8;
using w16 = ajax::w16;
using w32 = ajax::w32;
using w64 = ajax::w64;
using wfloat = ajax::wfloat;
using wdouble = ajax::wdouble;

// Eigen like naming convention
using packet32c = ajax::packet32c;
using packet16s = ajax::packet16s;
using packet8i = ajax::packet8i;
using packet4l = ajax::packet4l;
using packet8f = ajax::packet8f;
using packet4d = ajax::packet4d;
