...
template <is_simd_class T>
  requires(stdlib::is_same_v<typename T::bit_width, d128>)
inline T
fma(T &o, T &b, T &c)
{
...
template <is_simd_class T>
  requires(stdlib::is_same_v<typename T::bit_width, d256>)
inline T
fma(T &o, T &b, T &c)
{
...
template <is_simd_class T>
  requires(stdlib::is_same_v<typename T::bit_width, f128>)
inline T
fma(T &o, T &b, T &c)
{
...
template <is_simd_class T>
  requires(stdlib::is_same_v<typename T::bit_width, f256>)
inline T
fma(T &o, T &b, T &c)
{
